...
import (
	"github.com/MxelA/tmf-service-go/pkg/controllers"
...
var RegisterTmfServiceV4_2Routes = func(api *operations.ServiceOrderingV42API) {
	api.ServiceOrderCreateServiceOrderHandler = service_order.CreateServiceOrderHandlerFunc(controllers_tmf_service_v4_2.CreateServiceOrderControllerHandler)
}
