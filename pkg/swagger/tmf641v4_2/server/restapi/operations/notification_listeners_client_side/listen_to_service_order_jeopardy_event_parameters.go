...
func NewListenToServiceOrderJeopardyEventParams() ListenToServiceOrderJeopardyEventParams {
	...
	return ListenToServiceOrderJeopardyEventParams{}
}

// ListenToServiceOrderJeopardyEventParams contains all the bound params for the listen to service order jeopardy event operation
...
func (o *ListenToServiceOrderJeopardyEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ServiceOrderJeopardyEvent
