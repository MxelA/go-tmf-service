...
func NewListenToServiceOrderMilestoneEventParams() ListenToServiceOrderMilestoneEventParams {
	...
	return ListenToServiceOrderMilestoneEventParams{}
}

// ListenToServiceOrderMilestoneEventParams contains all the bound params for the listen to service order milestone event operation
...
func (o *ListenToServiceOrderMilestoneEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ServiceOrderMilestoneEvent
