...
func NewListenToServiceOrderCreateEventParams() ListenToServiceOrderCreateEventParams {
	...
	return ListenToServiceOrderCreateEventParams{}
}

// ListenToServiceOrderCreateEventParams contains all the bound params for the listen to service order create event operation
...
func (o *ListenToServiceOrderCreateEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ServiceOrderCreateEvent
