...
func NewListenToCancelServiceOrderCreateEventParams() ListenToCancelServiceOrderCreateEventParams {
	...
	return ListenToCancelServiceOrderCreateEventParams{}
}

// ListenToCancelServiceOrderCreateEventParams contains all the bound params for the listen to cancel service order create event operation
...
func (o *ListenToCancelServiceOrderCreateEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CancelServiceOrderCreateEvent
