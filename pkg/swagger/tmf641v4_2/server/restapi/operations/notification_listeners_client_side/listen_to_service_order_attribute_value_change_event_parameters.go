...
func NewListenToServiceOrderAttributeValueChangeEventParams() ListenToServiceOrderAttributeValueChangeEventParams {
	...
	return ListenToServiceOrderAttributeValueChangeEventParams{}
}

// ListenToServiceOrderAttributeValueChangeEventParams contains all the bound params for the listen to service order attribute value change event operation
...
func (o *ListenToServiceOrderAttributeValueChangeEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ServiceOrderAttributeValueChangeEvent
