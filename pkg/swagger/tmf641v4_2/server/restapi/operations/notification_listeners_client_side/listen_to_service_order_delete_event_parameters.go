...
func NewListenToServiceOrderDeleteEventParams() ListenToServiceOrderDeleteEventParams {
	...
	return ListenToServiceOrderDeleteEventParams{}
}

// ListenToServiceOrderDeleteEventParams contains all the bound params for the listen to service order delete event operation
...
func (o *ListenToServiceOrderDeleteEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ServiceOrderDeleteEvent
