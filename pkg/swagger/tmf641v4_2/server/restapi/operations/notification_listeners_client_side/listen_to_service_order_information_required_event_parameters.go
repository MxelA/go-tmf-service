...
func NewListenToServiceOrderInformationRequiredEventParams() ListenToServiceOrderInformationRequiredEventParams {
	...
	return ListenToServiceOrderInformationRequiredEventParams{}
}

// ListenToServiceOrderInformationRequiredEventParams contains all the bound params for the listen to service order information required event operation
...
func (o *ListenToServiceOrderInformationRequiredEventParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ServiceOrderInformationRequiredEvent
