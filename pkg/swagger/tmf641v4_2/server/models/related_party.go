...
func (m *RelatedParty) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAtReferredType(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RelatedParty) validateAtSchemaLocation(formats strfmt.Registry) error {
...
func (m *RelatedParty) validateHref(formats strfmt.Registry) error {
