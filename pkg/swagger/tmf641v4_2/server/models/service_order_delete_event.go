...
func (m *ServiceOrderDeleteEvent) validateEvent(formats strfmt.Registry) error {
...
func (m *ServiceOrderDeleteEvent) validateEventTime(formats strfmt.Registry) error {
...
func (m *ServiceOrderDeleteEvent) validateTimeOcurred(formats strfmt.Registry) error {
...
func (m *ServiceOrderDeleteEvent) contextValidateEvent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceOrderDeleteEvent) UnmarshalBinary(b []byte) error {
	var res ServiceOrderDeleteEvent
