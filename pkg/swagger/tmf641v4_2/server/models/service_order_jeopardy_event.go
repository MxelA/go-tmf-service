...
func (m *ServiceOrderJeopardyEvent) validateEvent(formats strfmt.Registry) error {
...
func (m *ServiceOrderJeopardyEvent) validateEventTime(formats strfmt.Registry) error {
...
func (m *ServiceOrderJeopardyEvent) validateTimeOcurred(formats strfmt.Registry) error {
...
func (m *ServiceOrderJeopardyEvent) contextValidateEvent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceOrderJeopardyEvent) UnmarshalBinary(b []byte) error {
	var res ServiceOrderJeopardyEvent
