...
func (m *ServiceOrderDeleteEventPayload) validateServiceOrder(formats strfmt.Registry) error {
...
func (m *ServiceOrderDeleteEventPayload) contextValidateServiceOrder(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceOrderDeleteEventPayload) UnmarshalBinary(b []byte) error {
	var res ServiceOrderDeleteEventPayload
