...
func (m *CancelServiceOrderCreateEvent) validateEvent(formats strfmt.Registry) error {
...
func (m *CancelServiceOrderCreateEvent) validateEventTime(formats strfmt.Registry) error {
...
func (m *CancelServiceOrderCreateEvent) validateTimeOcurred(formats strfmt.Registry) error {
...
func (m *CancelServiceOrderCreateEvent) contextValidateEvent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CancelServiceOrderCreateEvent) UnmarshalBinary(b []byte) error {
	var res CancelServiceOrderCreateEvent
