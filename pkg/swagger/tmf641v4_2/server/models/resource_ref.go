...
func (m *ResourceRef) validateAtSchemaLocation(formats strfmt.Registry) error {
...
func (m *ResourceRef) validateHref(formats strfmt.Registry) error {
...
func (m *ResourceRef) validateID(formats strfmt.Registry) error {
