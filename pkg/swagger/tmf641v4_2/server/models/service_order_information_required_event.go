...
type ServiceOrderInformationRequiredEvent struct {
	...
	FieldPath string `json:"fieldPath,omitempty" bson:"filePath,omitempty"`
...
func (m *ServiceOrderInformationRequiredEvent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceOrderInformationRequiredEvent) validateEvent(formats strfmt.Registry) error {
...
func (m *ServiceOrderInformationRequiredEvent) validateEventTime(formats strfmt.Registry) error {
...
func (m *ServiceOrderInformationRequiredEvent) validateTimeOcurred(formats strfmt.Registry) error {
...
func (m *ServiceOrderInformationRequiredEvent) contextValidateEvent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceOrderInformationRequiredEvent) UnmarshalBinary(b []byte) error {
	var res ServiceOrderInformationRequiredEvent
