...
func (m *ServiceRef) validateAtSchemaLocation(formats strfmt.Registry) error {
...
func (m *ServiceRef) validateHref(formats strfmt.Registry) error {
...
func (m *ServiceRef) validateID(formats strfmt.Registry) error {
