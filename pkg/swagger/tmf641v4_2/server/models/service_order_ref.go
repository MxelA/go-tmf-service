...
func (m *ServiceOrderRef) validateAtSchemaLocation(formats strfmt.Registry) error {
...
func (m *ServiceOrderRef) validateHref(formats strfmt.Registry) error {
...
func (m *ServiceOrderRef) validateID(formats strfmt.Registry) error {
