...
func (m *ServiceOrderCreateEvent) validateEvent(formats strfmt.Registry) error {
...
func (m *ServiceOrderCreateEvent) validateEventTime(formats strfmt.Registry) error {
...
func (m *ServiceOrderCreateEvent) validateTimeOcurred(formats strfmt.Registry) error {
...
func (m *ServiceOrderCreateEvent) contextValidateEvent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceOrderCreateEvent) UnmarshalBinary(b []byte) error {
	var res ServiceOrderCreateEvent
