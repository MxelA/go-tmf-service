...
func (m *ServiceOrderCreateEventPayload) validateServiceOrder(formats strfmt.Registry) error {
...
func (m *ServiceOrderCreateEventPayload) contextValidateServiceOrder(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceOrderCreateEventPayload) UnmarshalBinary(b []byte) error {
	var res ServiceOrderCreateEventPayload
