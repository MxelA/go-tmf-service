...
func (m *ServiceOrderStateChangeEvent) validateEvent(formats strfmt.Registry) error {
...
func (m *ServiceOrderStateChangeEvent) validateEventTime(formats strfmt.Registry) error {
...
func (m *ServiceOrderStateChangeEvent) validateTimeOcurred(formats strfmt.Registry) error {
...
func (m *ServiceOrderStateChangeEvent) contextValidateEvent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServiceOrderStateChangeEvent) UnmarshalBinary(b []byte) error {
	var res ServiceOrderStateChangeEvent
